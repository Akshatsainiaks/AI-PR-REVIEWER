      ...
      <div style={{ maxWidth: "900px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(180px,1fr))", gap: "14px", marginBottom: "28px" }}>
          {[
            ...
            <div key={card.label} style={{ background: V("db2"), border: `1px solid ${V("dborder")}`, borderRadius: "14px", padding: "20px" }}>
        ...
        {/* Bar chart */}
        <div style={{ background: V("db2"), border: `1px solid ${V("dborder")}`, borderRadius: "16px", padding: "24px 28px" }}>
          <h2 style={{ fontSize: "15px", fontWeight: 700, color: V("dt"), marginBottom: "20px" }}>Status Distribution</h2>
