    ...
    <AuthBg T={T}>
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: "420px" }}>
        ...
        <div style={{
          ...
          padding: "36px",
          boxShadow: landingTheme === "dark" ? "0 8px 60px rgba(0,0,0,0.4)" : "0 4px 40px rgba(0,0,0,0.08)"
        }}>
              ...
              return (
                <div key={label} style={{
                  ...
                  {i === 0 && <div style={{
                    width: 24,
                    height: 1,
                    background: step === "otp" ? T.accent : T.border,
          ...
          {step === "email" && (
            <>
              ...
              <p style={{
                ...
                marginBottom: "24px",
                lineHeight: 1.6
              }}>Enter your email and we'll send a 6-digit OTP.</p>
