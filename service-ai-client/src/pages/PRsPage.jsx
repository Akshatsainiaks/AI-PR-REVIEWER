      ...
      <div style={{ width: "100%" }}>
        ...
        {loading ? (
            ...
            {[1, 2, 3, 4].map((i) => (
              <div
                ...
                style={{
                  height: "64px",
                  borderRadius: "12px",
                  background: "linear-gradient(90deg,var(--db2) 25%,var(--db3) 50%,var(--db2) 75%)",
          ...
          >
            ...
            <p style={{ color: "var(--dt2)", fontSize: "13px" }}>
              Try changing the filter or go to Dashboard to add a PR
            </p>
          </div>
        ) : (
          <>
    ...
    >
      <div
        style={{
          ...
          borderRadius: "50%",
          flexShrink: 0,
          background: statusColor[pr.status] || "var(--dborder)",
          boxShadow: pr.status === "analyzing" ? "0 0 8px var(--da)" : "none",
        }}
      />
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <p style={{ fontSize: "11px", color: "var(--dt2)" }}>
            {new Date(pr.createdAt).toLocaleString("en-US", {
              month: "short",
              day: "numeric",
              hour: "2-digit",
              minute: "2-digit",
      ...
      <span
        style={{
          ...
          borderRadius: "5px",
          flexShrink: 0,
          background: `${statusColor[pr.status] || "var(--dborder)"}22`,
          color: statusColor[pr.status] || "var(--dt2)",
          border: `1px solid ${statusColor[pr.status] || "var(--dborder)"}44`,
        }}
      >
        {pr.status}
      </span>
