      ...
      <div style={{ position:"relative", zIndex:1, width:"100%", maxWidth:"460px" }}>
        ...
        <div style={{
          ...
          <p style={{ color:T.text2, fontSize:"14px", marginBottom:"28px" }}>
            Sign in to your Revuzen account
          </p>
          ...
          <form onSubmit={e=>{e.preventDefault();dispatch(login(form));}} style={{ display:"flex", flexDirection:"column", gap:"18px" }}>
            ...
            <AuthField label="Password" t={T} labelRight={
              <Link to="/forgot-password" style={{ fontSize:"12px", color:T.accent, textDecoration:"none" }}>
                Forgot password?
              </Link>
            }>
              <div style={{ position:"relative" }}>
                ...
                <button type="button" onClick={()=>setShowPass(v=>!v)} style={{
                  ...
                  color:T.text3, padding:"4px", display:"flex", alignItems:"center",
                }}>
                  {showPass ? <EyeOff/> : <Eye/>}
                </button>
              </div>
          ...
          <a href={`${import.meta.env.VITE_API_URL}/auth/github`} style={{
            ...
            color:T.text, textDecoration:"none", fontSize:"14px", fontWeight:500,
            transition:"all 0.2s",
          }}
...
export const AuthField = ({ label, labelRight, children, t }) => (
  <div>
    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:"6px" }}>
      <label style={{ fontSize:"13px", fontWeight:600, color:t?.text||"#eef0ff" }}>{label}</label>
      {labelRight}
    </div>
    {children}
  </div>
