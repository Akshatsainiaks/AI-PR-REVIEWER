...
export default function OAuthSuccess() {
  ...
  useEffect(() => {
    const run = async () => {
      ...
      try {
        // Save token to localStorage first so api.js interceptor can use it
        ...
        try {
          ...
          try {
            ...
            user = { id: decoded.id, email: "", fullName: "", role: decoded.role };
          } catch {
            user = { id: "", email: "", fullName: "", role: 2 };
          }
        }
    ...
    >
      ...
      <div
        style={{
          position: "fixed",
          inset: 0,
          backgroundImage: `radial-gradient(${T.text3} 1px,transparent 1px)`,
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "0 24px" }}>
        {status === "loading" && (
          <>
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill={T.text}>
              ...
              <span style={{ fontSize: "20px", fontWeight: 700, color: T.text }}>
